...
// Fork port (Patrick): cheap regex non-US pre-drop at scan time (~500-700 postings/day).
// Word-boundary regexes from lib/location-gate.mjs — more precise than the substring-based
// location_filter config. Drops only when a non-US signal is present AND no US hint is.
